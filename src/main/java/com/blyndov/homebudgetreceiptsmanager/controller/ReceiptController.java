...
public class ReceiptController {
    ...
    public ReceiptCorrectionResponse submitReceiptCorrection(
        @PathVariable Long id,
        @RequestBody ReceiptCorrectionRequest request
    ) {
        return receiptService.submitReceiptCorrection(id, request);
    }
}
